...
namespace yutovo_calc
{
	...
	struct Expression : qi::grammar<std::string::iterator, ExpressionNode<Number>(), qi::space_type>
	{
		...
		qi::rule<std::string::iterator, UnaryOperationNode<Number>(), qi::space_type> unaryOperation;
		qi::rule<std::string::iterator, IdentifierNode<Number>(), qi::space_type> identifier;
		qi::rule<std::string::iterator, FunctionCallNode<Number>(), qi::space_type> functionCall;
		qi::rule<std::string::iterator, std::string(), qi::space_type> str, expNumber;
