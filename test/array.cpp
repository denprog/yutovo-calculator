...
TEST_F(CalcTestArrayReal, graph1)
{
    ...
    ASSERT_TRUE(res.ToStdString(3, 3) == 
        "[0.E+0,1.E+0,0.E+0,1.E+0,0.E+0,0.E+0,0.02E+0,0.02E+0,0.04E+0,0.04E+0,0.06E+0,0.06E+0,0.08E+0,0.0799E+0,0.1E+0,"
        "0.0998E+0,0.12E+0,0.12E+0,0.14E+0,0.14E+0,0.16E+0,0.159E+0,0.18E+0,0.179E+0,0.2E+0,0.199E+0,0.22E+0,0.218E+0,"
        "0.24E+0,0.238E+0,0.26E+0,0.257E+0,0.28E+0,0.276E+0,0.3E+0,0.296E+0,0.32E+0,0.315E+0,0.34E+0,0.333E+0,0.36E+0,"
        "0.352E+0,0.38E+0,0.371E+0,0.4E+0,0.389E+0,0.42E+0,0.408E+0,0.44E+0,0.426E+0,0.46E+0,0.444E+0,0.48E+0,0.462E+0,"
        "0.5E+0,0.479E+0,0.52E+0,0.497E+0,0.54E+0,0.514E+0,0.56E+0,0.531E+0,0.58E+0,0.548E+0,0.6E+0,0.565E+0,0.62E+0,"
        "0.581E+0,0.64E+0,0.597E+0,0.66E+0,0.613E+0,0.68E+0,0.629E+0,0.7E+0,0.644E+0,0.72E+0,0.659E+0,0.74E+0,0.674E+0,0.76E+0,"
        "0.689E+0,0.78E+0,0.703E+0,0.8E+0,0.717E+0,0.82E+0,0.731E+0,0.84E+0,0.745E+0,0.86E+0,0.758E+0,0.88E+0,0.771E+0,0.9E+0,"
        "0.783E+0,0.92E+0,0.796E+0,0.94E+0,0.808E+0,0.96E+0,0.819E+0,0.98E+0,0.83E+0,1.E+0,0.841E+0]") <<
        res.ToStdString(3, 3);
}

TEST_F(CalcTestArrayReal, graph2)
{
    yutovo_calculator::ParserContext parser_context;
    parser_context.Init(100);
    auto res = parser.Parse(LogicalId{0, 0, 1}, U"graph_line(sin(x),x,0,100,0,100,100);", &parser_context);
    ASSERT_TRUE(res.ToStdString(3, 3).substr(0, 100) == 
        "[0.E+0,100.E+0,0.E+0,100.E+0,0.E+0,0.E+0,1.E+0,0.841E+0,2.E+0,0.909E+0,3.E+0,0.141E+0,4.E+0,-0.757E+") << 
