...
{
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"f(x)=5;") == Real());
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"f(x)=x+5;f(2);") == parser.Parse(ElementId{0, 0, 1}, U"7;"));
}
...
TEST_F(CalcTestReal, variables1)
{
    ...
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"v=555;v;") == parser.Parse(ElementId{0, 0, 1}, U"555;")) << 
        parser.Parse(ElementId{0, 0, 1}, U"v=555;v;").ToStdString(3, 3);
    ...
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"v=55.5;v;") == parser.Parse(ElementId{0, 0, 1}, U"55.5;")) << 
        parser.Parse(ElementId{0, 0, 1}, U"v=55.5;v;").ToStdString(3, 3);
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"vp=55.5;vp+5;", dependencies) == parser.Parse(ElementId{0, 0, 1}, U"60.5;")) << 
        parser.Parse(ElementId{0, 0, 1}, U"vp=55.5;vp+5;").ToStdString(3, 3);
    ASSERT_TRUE(std::find(dependencies.begin(), dependencies.end(), U"vp") != dependencies.end());
}

TEST_F(CalcTestReal, variables2)
{
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"п=555;п;") == parser.Parse(ElementId{0, 0, 1}, U"555;")) << 
        parser.Parse(ElementId{0, 0, 1}, U"п=555;п;").ToStdString(3, 3);
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"п=55.5;п;") == parser.Parse(ElementId{0, 0, 1}, U"55.5;")) << 
        parser.Parse(ElementId{0, 0, 1}, U"п=55.5;п;").ToStdString(3, 3);
    ASSERT_TRUE(parser.Parse(ElementId{0, 0, 1}, U"пр=55.5;пр+5;") == parser.Parse(ElementId{0, 0, 1}, U"60.5;")) << 
        parser.Parse(ElementId{0, 0, 1}, U"пр=55.5;п+5;").ToStdString(3, 3);
}
